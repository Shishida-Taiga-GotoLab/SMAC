...
module subprogs
    ...
    ! 予測速度を計算
    subroutine prespeed_cal(Ax, Ay, Bx, By, u, u_pre, v, v_pre, dpdx, dpdy, p, Fx, Fy)
...
program main
    ...
    do k = 1, steps
        ...
        call prespeed_cal(Ax, Ay, Bx, By, u, u_pre, v, v_pre, dpdx, dpdy, p, Fx, Fy) ! 予測速度計算
